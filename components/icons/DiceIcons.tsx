...
// Common SVG props for all dice faces to ensure consistent sizing and coloring.
const commonProps = {
  viewBox: "0 0 24 24",
  fill: "currentColor",
...
// SVG components for each dice face (1 through 6)
...
// Main DiceIcon component that conditionally renders the correct dice face based on the 'value' prop.
